...
if (!class_exists('HoneyBee_About_Page')) {
    ...
    class HoneyBee_About_Page {
        ...
        function __construct() {
            ...
            add_action('honeybee_info_screen', array($this, 'welcome_free_pro'), 50);
            add_action('honeybee_info_screen', array($this, 'recommended_actions'), 50);
            add_action('honeybee_info_screen', array($this, 'changelog'), 60);
        }
        ...
        public function welcome_free_pro() {
            require_once( HONEYBEE_CHILD_TEMPLATE_DIR . '/admin/tab-pages/free_vs_pro.php' );
        }
        ...
        public function changelog() {
            ...
            ?>
            <div id="changelog" class="honeybee-tab-pane panel-close">
                <div class="wrap about-wrap">

                    <?php //$this->intro(); ?>

                    <p class="about-description"><?php esc_html_e('See changelog below:', 'honeybee'); ?></p>

                    <?php
                    $changelog_file = apply_filters('honeybee_changelog_file', HONEYBEE_CHILD_TEMPLATE_DIR . '/changelog.txt');
        ...
        public function get_tabs_array() {
            ...
            $tabs_array[] = array(
                'link' => 'changelog',
                'name' => esc_html__('Changelog', 'honeybee')
            );

            $tabs_array[] = array(
                'link' => 'free_vs_pro',
                'name' => esc_html__('Free vs. PRO', 'honeybee'),
                'file_path' => HONEYBEE_CHILD_TEMPLATE_DIR . '/admin/tab-pages/free-vs-pro.php',
            );
