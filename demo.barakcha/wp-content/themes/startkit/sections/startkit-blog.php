...
<section id="recent-blog" class="section-padding">
	<div class="container">
		<?php if ( ! empty( $startkit_blog_title ) || ! empty( $startkit_blog_desc )) :?>
			<div class="row">
		...
		<div class="row">
			<?php 	
				 if ( function_exists( 'cleverfox_activate' ) ) { 
					...
					$startkit_args = array( 'post_type' => 'post','post__not_in'=>get_option("sticky_posts")) ; 	
				}
							...
							<div class="post-thumbnail">
								...
								<ul class="meta-info list-inline">
									...
									<li class="post-date"><?php echo esc_html(get_the_date('j M Y')); ?></li>
									 ...
									 <?php   $startkit_cat_list = get_the_category_list();
									if(!empty($startkit_cat_list)) { ?>
