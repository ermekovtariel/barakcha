                    ...
                    <td>
                        <fieldset>
                            <label for="apsfc_force_lang">
                                <input name="apsfc_force_lang" type="checkbox" id="apsfc_force_lang" value="<?php echo get_option('apsfc_force_lang'); ?>" <?php echo get_option('apsfc_force_lang') == "on" ? " checked" : ""; ?>>
                                Force <i>"The language is set from content"</i> in <strong><code>Language</code> > <code>Settings</code> > <code>URL modifications</code></code></strong>?
                            </label>
                        </fieldset>
                    </td>
                    </tr>
