...
class WP_Reset
{
  ...
  private function tab_reset()
  {
    ...
    echo '</p>';
    echo '<p><i class="dashicons dashicons-no red" style="vertical-align: bottom;"></i> - tool WILL delete, reset or destroy the noted data<br>';
    ...
    foreach ($rows as $tool => $opt) {
      ...
      if (empty($opt[0])) {
        ...
        echo '<td><i class="dashicons dashicons-no red" title="Data WILL BE deleted, reset or modified"></i></td>';
      }
      if (empty($opt[1])) {
        echo '<td><i class="dashicons dashicons-yes" title="Data will NOT be deleted, reset or modified"></i></td>';
      } else {
