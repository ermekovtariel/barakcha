    ...
    <footer class="site-footer">  
        ...
        if($honeybee_user=='old'){?>
            <div class="site-info text-center">
                <?php $honeybee_footer_copyright = get_theme_mod('footer_copyright', '<p>' . __('Proudly powered by <a href="https://kundoluk.kg"> Kundoluk</a> ', 'honeybee') . '</p>'); ?>  
            <?php echo wp_kses_post($honeybee_footer_copyright); ?> 
            </div>
        <?php } else{?>
            <div class="site-info text-center 2">
                 <p><?php esc_html_e( 'Proudly powered by', 'honeybee' ); ?> 
<a href="https://kundoluk.kg">Kundoluk</a></p>
            </div>
        <?php } ?>
    </footer>
    <?php
