	      ...
	      <?php if( is_active_sidebar( 'footer-one' ) || is_active_sidebar( 'footer-two' ) || is_active_sidebar( 'footer-three' ) ) { ?>
			...
			<div class="site-info">
                ...
                <?php 
    			    ...
    			    <span class="by">
                        <?php echo esc_html__( 'Developed By', 'school-zone' ); ?>
                        <a href="<?php echo esc_url( 'https://kundoluk.kg/' ); ?>" rel="nofollow" target="_blank"><?php esc_html_e( 'Kundoluk', 'school-zone' ); ?></a>.
